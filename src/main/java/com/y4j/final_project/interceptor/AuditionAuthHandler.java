...
public class AuditionAuthHandler implements HandlerInterceptor {

	//상품 관리 섹션 접근 권한 처리
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
			throws Exception {
		
		System.out.println("AuditionAuthHandler - preHandle Execute!");
		...
		} else if(!admin_type.equals("audition")) {
